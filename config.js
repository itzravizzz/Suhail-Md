...
global.devs = "+94 720654173" // Developer Contact
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "null";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "+94 72065417";
...
module.exports = {
  ...
  caption : global.caption || "" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ ©ravishan-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
 
  author : process.env.PACK_AUTHER|| "©ravishan-ᴍᴅ",
  packname: process.env.PACK_NAME || "©ravishan-ᴍᴅ",
  botname : process.env.BOT_NAME  || "©ravishan-ᴍᴅ",
